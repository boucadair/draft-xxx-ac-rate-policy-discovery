...
* Applications can send/receive data at different rates for reliable and unreliable traffic (reliable could map to QB and unreliable could map to NQB) by mapping reliability flag. One of the ways for application to make reliability markings visible is by following the considerations in {{Section 4 of ?I-D.ietf-tsvwg-nqb}}.
